...
export const UseAssetServiceGetAssetAliasesKeyFn = ({ limit, namePattern, namePrefixPattern, offset, orderBy }: {
  limit?: number;
  namePattern?: string;
  namePrefixPattern?: string;
  offset?: number;
  orderBy?: string[];
} = {}, queryKey?: Array<unknown>) => [useAssetServiceGetAssetAliasesKey, ...(queryKey ?? [{ limit, namePattern, namePrefixPattern, offset, orderBy }])];
...
export type ConnectionServiceGetConnectionTestDefaultResponse = Awaited<ReturnType<typeof ConnectionService.getConnectionTest>>;
export type ConnectionServiceGetConnectionTestQueryResult<TData = ConnectionServiceGetConnectionTestDefaultResponse, TError = unknown> = UseQueryResult<TData, TError>;
...
}, queryKey?: Array<unknown>) => [useConnectionServiceGetConnectionTestKey, ...(queryKey ?? [{ airflowConnectionTestToken }])];
...
export const UseConnectionServiceGetConnectionsKeyFn = ({ connectionIdPattern, connectionIdPrefixPattern, limit, offset, orderBy }: {
  connectionIdPattern?: string;
  connectionIdPrefixPattern?: string;
  limit?: number;
  offset?: number;
  orderBy?: string[];
} = {}, queryKey?: Array<unknown>) => [useConnectionServiceGetConnectionsKey, ...(queryKey ?? [{ connectionIdPattern, connectionIdPrefixPattern, limit, offset, orderBy }])];
...
export const UseDagServiceGetDagTagsKeyFn = ({ limit, offset, orderBy, tagNamePattern, tagNamePrefixPattern }: {
  limit?: number;
  offset?: number;
  orderBy?: string[];
  tagNamePattern?: string;
  tagNamePrefixPattern?: string;
} = {}, queryKey?: Array<unknown>) => [useDagServiceGetDagTagsKey, ...(queryKey ?? [{ limit, offset, orderBy, tagNamePattern, tagNamePrefixPattern }])];
...
export const UsePoolServiceGetPoolsKeyFn = ({ limit, offset, orderBy, poolNamePattern, poolNamePrefixPattern }: {
  limit?: number;
  offset?: number;
  orderBy?: string[];
  poolNamePattern?: string;
  poolNamePrefixPattern?: string;
} = {}, queryKey?: Array<unknown>) => [usePoolServiceGetPoolsKey, ...(queryKey ?? [{ limit, offset, orderBy, poolNamePattern, poolNamePrefixPattern }])];
...
export const UseVariableServiceGetVariablesKeyFn = ({ limit, offset, orderBy, variableKeyPattern, variableKeyPrefixPattern }: {
  limit?: number;
  offset?: number;
  orderBy?: string[];
...
export const UsePartitionedDagRunServiceGetPartitionedDagRunsKeyFn = ({ dagId, hasCreatedDagRunId, limit, offset }: {
  dagId?: string;
  hasCreatedDagRunId?: boolean;
  limit?: number;
  offset?: number;
} = {}, queryKey?: Array<unknown>) => [usePartitionedDagRunServiceGetPartitionedDagRunsKey, ...(queryKey ?? [{ dagId, hasCreatedDagRunId, limit, offset }])];
...
export type CalendarServiceGetCalendarDeadlinesDefaultResponse = Awaited<ReturnType<typeof CalendarService.getCalendarDeadlines>>;
export type CalendarServiceGetCalendarDeadlinesQueryResult<TData = CalendarServiceGetCalendarDeadlinesDefaultResponse, TError = unknown> = UseQueryResult<TData, TError>;
export const useCalendarServiceGetCalendarDeadlinesKey = "CalendarServiceGetCalendarDeadlines";
export const UseCalendarServiceGetCalendarDeadlinesKeyFn = ({ dagId, deadlineTimeGt, deadlineTimeGte, deadlineTimeLt, deadlineTimeLte, granularity }: {
  dagId: string;
  deadlineTimeGt?: string;
  deadlineTimeGte?: string;
  deadlineTimeLt?: string;
...
export type ConnectionServiceEnqueueConnectionTestMutationResult = Awaited<ReturnType<typeof ConnectionService.enqueueConnectionTest>>;
...
export type TaskInstanceServiceRunManualSectionMutationResult = Awaited<ReturnType<typeof TaskInstanceService.runManualSection>>;
...
export type AuthLinksServiceGenerateTokenMutationResult = Awaited<ReturnType<typeof AuthLinksService.generateToken>>;
...
export type TaskInstanceServicePatchTaskGroupInstancesMutationResult = Awaited<ReturnType<typeof TaskInstanceService.patchTaskGroupInstances>>;
export type TaskInstanceServicePatchTaskGroupInstancesDryRunMutationResult = Awaited<ReturnType<typeof TaskInstanceService.patchTaskGroupInstancesDryRun>>;
