...
export class TaskInstanceService {
     ...
     * @throws ApiError
     */
    public static runManualSection(data: RunManualSectionData): CancelablePromise<RunManualSectionResponse> {
        return __request(OpenAPI, {
            method: 'POST',
            url: '/api/v2/dags/{dag_id}/dagRuns/{dag_run_id}/taskInstances/{task_id}/runManualSection',
            path: {
                dag_id: data.dagId,
                dag_run_id: data.dagRunId,
                task_id: data.taskId
    ...
    public static getHitlDetailTryDetail(data: GetHitlDetailTryDetailData): CancelablePromise<GetHitlDetailTryDetailResponse> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/v2/dags/{dag_id}/dagRuns/{dag_run_id}/taskInstances/{task_id}/{map_index}/hitlDetails/tries/{try_number}',
            path: {
                dag_id: data.dagId,
                dag_run_id: data.dagRunId,
                task_id: data.taskId,
...
export class AuthLinksService {
     ...
     * @throws ApiError
     */
    public static generateToken(data: GenerateTokenData): CancelablePromise<GenerateTokenResponse2> {
        return __request(OpenAPI, {
            method: 'POST',
            url: '/ui/auth/token',
            body: data.requestBody,
...
export class GridService {
     ...
     * @throws ApiError
     */
    public static getGridTiSummariesStream(data: GetGridTiSummariesStreamData): CancelablePromise<GetGridTiSummariesStreamResponse> {
        return __request(OpenAPI, {
            method: 'GET',
...
export class GanttService {
     ...
     * @throws ApiError
     */
    public static getGanttData(data: GetGanttDataData): CancelablePromise<GetGanttDataResponse> {
        return __request(OpenAPI, {
            method: 'GET',
